...
public abstract class PositionChangeEvent {
    ...
    // Constructor for Underflow, Overflow, Hit, and Bounce Game.Events
    PositionChangeEvent(Player player, int moves, int advance, int oldPosition, int newPosition) {
        this(player, moves, advance, oldPosition, newPosition, 0);
    }

    // Constructor for HomeEvent
    PositionChangeEvent(Player player, int moves, int advance, int oldPosition, int newPosition, int totalMoves) {
        this.player = player;
