...
public class Facade implements IFacade {
    ...
    public void play(int numberOfDice, int numberOfPlayers, int boardSize, boolean disableHitEvent, boolean disableBounceEvent) {
        ...
        for (int i = 0; i < numberOfPlayers; i++) {
            ...
            playerList.add(playerFactory.createPlayer(colors[i], homePosition, tailDiversion));
        }
...
//        factory = new Dice.FixedDiceShakerFactory();
        ...
        GameBoard game = new GameBoard(boardSize, playerList, factory.create(), disableHitEvent, disableBounceEvent, playerManager);
