...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Do you want to disable the Hit functionality to be enabled? (true/false):");
        ...
        System.out.println("Do you want to disbale the bounce functionaly? (true/false):");
        while (!scanner.hasNextBoolean()) {
            System.out.println("Please enter true or false:");
            scanner.next(); // Consume invalid input
        }
